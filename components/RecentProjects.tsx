...
export default function RecentProjects() {
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap itmes-center justify-center gap-y-8 p-4 gap-x-24 mt-10">
        {" "}
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className="lg:min-h-[32.5] sm:h-[41rem] h-[32rem]  flex items-center justify-center sm:w-[570px] w-[80vw] mb-8"
          >
