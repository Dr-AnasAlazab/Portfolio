...
export default function Hero() {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="z- h-screen  flex w-full items-center justify-center bg-white dark:bg-black-100 absolute top-0 left-0 dark:bg-grid-white/[0.03]">
        <div
          className={cn(
            "absolute inset-0",
      ...
      <div className="flex max-w-full justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Transforming Concepts into Seamless User Expericences"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi,I&apos;m Anas, a Next.js Developer
          </p>
